import*as n from"../../libs/three/three.module.js";function I(){return`
    #ifdef GL_FRAGMENT_PRECISION_HIGH
      precision highp float;
    #else
      precision mediump float;
    #endif
        `}import*as S from"../../libs/three/three.module.js";function U(l=!1){let e=`
    ...
    void main(){
        ...
        gl_FragColor=Cd;
    }`,e}import*as w from"../../libs/three/three.module.js";var E=w.Vector2,b=w.Vector3;var W={NONE:0,ERROR:1,WARN:2,INFO:3},k={OFF:0,LOW:1,MEDIUM:2,HIGH:3},j={verbose:W.NONE,pxlRoomRoot:"./pxlRooms",staticCamera:!1,autoCamera:!1,antiAliasing:k.LOW,LoadEnvAssetFile:!1};import*as f from"../../libs/three/three.module.js";import*as P from"../../libs/three/three.module.js";function A(l=!1){let e=`
    attribute vec3 color;
    attribute vec3 shading;
